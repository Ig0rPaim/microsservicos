...
{
    public class UserVOIn : Notifiable<Notification>
    {
        ...
        public UserVOIn(int id, string nome, string password, string email, string phone)
        {
            var contract = new Contract<UserVOIn>() //Flunt
                .Requires()
